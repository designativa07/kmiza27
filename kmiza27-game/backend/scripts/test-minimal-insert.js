...
async function testMinimalInsert() {
  console.log('🧪 TESTANDO INSERÇÃO MÍNIMA - IDENTIFICANDO CAMPO PROBLEMÁTICO');
  console.log('==================================================================\n');
  ...
  try {
    ...
    console.log('📝 Tentando inserir com apenas campos obrigatórios...');
    console.log('📋 Campos:', Object.keys(minimalPlayer));
    ...
    if (minimalError) {
      ...
      if (minimalError.message.includes('numeric field overflow')) {
        ...
        const testFields = ['id', 'team_id', 'name', 'created_at', 'updated_at'];
    ...
    if (extremeError) {
      ...
      if (extremeError.message.includes('numeric field overflow')) {
        ...
        const numericFields = ['age', 'potential', 'goalkeeping'];
