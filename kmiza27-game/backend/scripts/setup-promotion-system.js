...
console.log('🏆 CONFIGURANDO SISTEMA DE PROMOÇÃO/REBAIXAMENTO');
console.log('=' .repeat(50));

async function setupPromotionSystem() {
  try {
    ...
    for (const competition of competitions) {
      ...
      switch (competition.tier) {
        case 1: // Série A
          updateData = {
            ...
            is_open_for_new_users: false // Não aceita novos usuários
          };
          break;
        case 2: // Série B
          updateData = {
        ...
        case 4: // Série D
          updateData = {
            ...
            is_open_for_new_users: true // Aceita novos usuários
          };
          break;
      }
      ...
      if (updateError) {
        ...
        console.log(`   - Aceita novos usuários: ${updateData.is_open_for_new_users}`);
      }
    }
