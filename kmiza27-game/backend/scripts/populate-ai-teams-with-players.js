...
/**
 * 🎮 POPULAÇÃO DOS TIMES DA IA COM JOGADORES
 * 
 * Objetivos:
 * 1. Criar jogadores para todos os times da IA
 * 2. Resolver problema do mercado vazio
 * 3. Permitir que a IA funcione corretamente
 * 4. Manter equilíbrio e jogabilidade
 */
...
async function populateAITeamsWithPlayers() {
  try {
    console.log('🎮 POPULAÇÃO DOS TIMES DA IA COM JOGADORES');
    ...
    for (const team of aiTeams) {
      ...
      for (let i = 0; i < 23; i++) {
        ...
        youthPlayers.push({
          ...
          team_id: team.id,
          attributes,
          // REMOVIDO: potential_overall é gerado automaticamente
      ...
      for (let i = 0; i < 23; i++) {
        ...
        // REMOVIDO: current_ability é gerado automaticamente
        ...
        proPlayers.push({
          ...
          // REMOVIDO: current_ability e potential são gerados automaticamente
          // Dados de mercado
          market_value: marketValue,
          salary,
          wage: salary,
