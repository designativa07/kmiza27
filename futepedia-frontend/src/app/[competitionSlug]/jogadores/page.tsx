...
export default function CompetitionPlayersPage({ params }: { params: { competitionSlug: string } }) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const competitionData = await getCompetition(params.competitionSlug);
        if (competitionData) {
          setCompetition(competitionData);
          const playersData = await getCompetitionPlayers(competitionData.id);
