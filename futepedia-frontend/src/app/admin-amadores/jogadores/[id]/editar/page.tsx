...
export default function EditarJogadorPage() {
  ...
  const fetchPlayer = async () => {
    try {
      ...
      const response = await fetch(`/api/amateur/players/${playerId}`, {
        headers: {
      ...
      if (response.ok) {
        ...
        console.log('Data original do backend:', player.date_of_birth);
        console.log('Data formatada para o formulário:', formDataToSet.date_of_birth);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setError(errorData.message || 'Erro ao atualizar jogador');
      }
    } catch (error) {
      setError('Erro de conexão');
    } finally {
      ...
      <div className="bg-gray-50 min-h-screen">
        ...
        <main className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex items-center justify-center">
            ...
            <span className="ml-2 text-gray-600">Carregando jogador...</span>
          </div>
        </main>
      </div>
    );
      ...
      <main className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-4 mb-6">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Editar Jogador</h1>
              <p className="text-gray-600 mt-2">
                Atualize os dados do jogador amador
              </p>
            </div>
          </div>
