...
const JogosSemanaPage: NextPage = () => {
  ...
  useEffect(() => {
    const fetchMatches = async () => {
      try {
        ...
        if (!response.ok) {
          throw new Error('Erro ao buscar jogos da semana');
        }
        const data = await response.json();
        setMatches(data);
      } catch (err) {
        console.error('Erro ao buscar jogos da semana:', err);
        setError('Erro ao carregar jogos da semana');
      } finally {
        setLoading(false);
      }
    };
        ...
        <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="bg-white rounded-lg shadow-sm">
            <div className="p-4 border-b border-gray-100">
              <h1 className="text-xl font-bold text-gray-900">Jogos da Semana</h1>
            </div>
            <div className="p-4">
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="bg-white rounded-lg shadow-sm">
          <div className="p-4 border-b border-gray-100">
            <h1 className="text-xl font-bold text-gray-900 mb-4">Jogos da Semana</h1>
          ...
          <div className="p-4">
            {matches.length === 0 ? (
              <div className="text-center py-8">
                <p className="text-gray-600 text-lg">Não há jogos agendados para esta semana.</p>
...
export default JogosSemanaPage; 