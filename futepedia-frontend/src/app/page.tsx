                 ...
                 <div className="grid grid-cols-2 gap-2">
                   <Link href="/amadores" className="group block p-2 bg-indigo-50 rounded-lg hover:bg-indigo-100 transition-colors">
                     <div className="flex flex-col items-center text-center">
                       ...
                       <p className="mt-1 font-medium text-xs text-gray-700">Campeonatos Amadores</p>
                     </div>
                   </Link>
                   <button 
                     onClick={handleAmateurAreaClick}
                     className="group block p-2 bg-green-50 rounded-lg hover:bg-green-100 transition-colors"
                   >
                     <div className="flex flex-col items-center text-center">
                       <div className="p-1 bg-green-100 rounded-full">
                       ...
                       <p className="mt-1 font-medium text-xs text-gray-700">Área do Amador</p>
                     </div>
                   </button>
                 </div>
               </div>
