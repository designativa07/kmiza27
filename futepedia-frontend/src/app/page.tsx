              ...
              <div className="grid grid-cols-1 gap-4">
                <Link href="/jogadores" className="group block p-4 bg-yellow-50 rounded-lg hover:bg-yellow-100 transition-colors">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      <h4 className="font-bold text-gray-900">Jogadores</h4>
                      <p className="text-sm text-gray-600">Conheça os craques</p>
                    </div>
                  </div>
                </Link>

                <Link href="/estadios" className="group block p-4 bg-orange-50 rounded-lg hover:bg-orange-100 transition-colors">
                  <div className="flex items-center">
                    <div className="p-2 bg-orange-100 rounded-full">
                      <Building className="h-5 w-5 text-orange-600" />
                    </div>
                    <div className="ml-4">
                      <h4 className="font-bold text-gray-900">Estádios</h4>
                      <p className="text-sm text-gray-600">Visite as arenas</p>
                    </div>
                  </div>
                </Link>
                
                <div>
                  <h4 className="font-bold text-gray-900 mb-2 px-1">Futebot</h4>
                  <div className="grid grid-cols-2 gap-4">
                      <a href="https://wa.me/554896265397" target="_blank" rel="noopener noreferrer" className="group block p-4 bg-green-50 rounded-lg hover:bg-green-100 transition-colors">
                        <div className="flex items-center justify-center">
                          ...
                          <p className="ml-2 font-medium text-sm text-gray-700">WhatsApp</p>
                        </div>
                      </a>

                      <Link href="/futebot" className="group block p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
                        <div className="flex items-center justify-center">
                          <div className="p-2 bg-blue-100 rounded-full">
                           ...
                           <p className="ml-2 font-medium text-sm text-gray-700">Chat</p>
                        </div>
                      </Link>
                  </div>
                </div>
