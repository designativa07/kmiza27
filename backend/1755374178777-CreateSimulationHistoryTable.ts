...
export class CreateSimulationHistoryTable1755374178777 implements MigrationInterface {
    name = 'CreateSimulationHistoryTable1755374178777'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "titles" ("id" SERIAL NOT NULL, "name" character varying(255) NOT NULL, "competition_name" character varying(255), "season" character varying(100), "year" integer, "description" text, "category" character varying(50), "type" character varying(50), "display_order" integer, "is_active" boolean NOT NULL DEFAULT true, "image_url" text, "team_id" integer NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_7c5aeca381c331c3aaf9d50931c" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "simulation_history" ("id" SERIAL NOT NULL, "competition_id" integer NOT NULL, "executed_at" TIMESTAMP NOT NULL DEFAULT now(), "results" jsonb NOT NULL, CONSTRAINT "PK_8f1905d3e491ddd37344065fccb" PRIMARY KEY ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TABLE "simulation_history"`);
