...
export class AddPlayersAndMatchStats1749307697418 implements MigrationInterface {
    name = 'AddPlayersAndMatchStats1749307697418'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "player_team_history" ("id" SERIAL NOT NULL, "start_date" date NOT NULL, "end_date" date, "jersey_number" character varying(50), "role" character varying(50), "player_id" integer NOT NULL, "team_id" integer NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_4fcf9cd8c9c36db784be411dbff" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "cards" ("id" SERIAL NOT NULL, "match_id" integer NOT NULL, "player_id" integer NOT NULL, "type" character varying(20) NOT NULL, "minute" integer, "reason" character varying(255), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_5f3269634705fdff4a9935860fc" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "players" ("id" SERIAL NOT NULL, "name" character varying(255) NOT NULL, "position" character varying(50), "date_of_birth" date, "nationality" character varying(100), "image_url" character varying(255), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_de22b8fdeee0c33ab55ae71da3b" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "goals" ADD "player_id" integer NOT NULL`);
        await queryRunner.query(`ALTER TABLE "goals" ADD "type" character varying(255)`);
        await queryRunner.query(`ALTER TABLE "goals" ADD "updated_at" TIMESTAMP NOT NULL DEFAULT now()`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "goals" DROP COLUMN "player_id"`);
