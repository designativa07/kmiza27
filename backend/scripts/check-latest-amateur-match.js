...
async function checkLatestAmateurMatch() {
  try {
    console.log('Verificando o último jogo amador criado...');

    // Buscar o último jogo amador
