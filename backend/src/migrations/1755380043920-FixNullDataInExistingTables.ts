...
export class FixNullDataInExistingTables1755380043920 implements MigrationInterface {
    name = 'FixNullDataInExistingTables1755380043920'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "titles" DROP CONSTRAINT "FK_3e98fc29df8faba85b1b5c00c1a"`);
        ...
        await queryRunner.query(`ALTER TABLE "titles" DROP COLUMN "display_order"`);
        await queryRunner.query(`ALTER TABLE "titles" DROP COLUMN "is_active"`);
        await queryRunner.query(`ALTER TABLE "titles" DROP COLUMN "created_at"`);
        await queryRunner.query(`ALTER TABLE "titles" DROP COLUMN "updated_at"`);
        await queryRunner.query(`ALTER TABLE "titles" DROP COLUMN "name"`);
        await queryRunner.query(`ALTER TABLE "titles" DROP COLUMN "competition_name"`);
        await queryRunner.query(`ALTER TABLE "titles" DROP COLUMN "season"`);
        await queryRunner.query(`ALTER TABLE "titles" DROP COLUMN "description"`);
        await queryRunner.query(`ALTER TABLE "titles" DROP COLUMN "category"`);
        await queryRunner.query(`ALTER TABLE "titles" DROP COLUMN "type"`);
        await queryRunner.query(`ALTER TABLE "titles" DROP COLUMN "image_url"`);
        ...
        await queryRunner.query(`ALTER TABLE "competition_teams" DROP CONSTRAINT "competition_teams_pkey"`);
        await queryRunner.query(`ALTER TABLE "competition_teams" DROP COLUMN "id"`);
        await queryRunner.query(`ALTER TABLE "competition_teams" DROP COLUMN "position"`);
        await queryRunner.query(`ALTER TABLE "competition_teams" DROP COLUMN "points"`);
        await queryRunner.query(`ALTER TABLE "competition_teams" DROP COLUMN "played"`);
        await queryRunner.query(`ALTER TABLE "competition_teams" DROP COLUMN "won"`);
        await queryRunner.query(`ALTER TABLE "competition_teams" DROP COLUMN "drawn"`);
        await queryRunner.query(`ALTER TABLE "competition_teams" DROP COLUMN "lost"`);
        await queryRunner.query(`ALTER TABLE "competition_teams" DROP COLUMN "goals_for"`);
        await queryRunner.query(`ALTER TABLE "competition_teams" DROP COLUMN "goals_against"`);
        ...
        await queryRunner.query(`ALTER TABLE "competition_teams" DROP COLUMN "created_at"`);
        await queryRunner.query(`ALTER TABLE "competition_teams" DROP COLUMN "updated_at"`);
        await queryRunner.query(`ALTER TABLE "competition_teams" DROP COLUMN "group_name"`);
        await queryRunner.query(`ALTER TABLE "competition_teams" DROP COLUMN "form"`);
        await queryRunner.query(`ALTER TABLE "titles" ADD "competition_id" integer NOT NULL`);
        await queryRunner.query(`ALTER TABLE "competition_teams" ADD "id" SERIAL NOT NULL`);
        await queryRunner.query(`ALTER TABLE "competition_teams" ADD CONSTRAINT "PK_7deea733e2bee683c45130783a0" PRIMARY KEY ("id")`);
        await queryRunner.query(`ALTER TABLE "competition_teams" ADD "group_name" character varying(50)`);
        await queryRunner.query(`ALTER TABLE "competition_teams" ADD "position" integer`);
        await queryRunner.query(`ALTER TABLE "competition_teams" ADD "points" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "competition_teams" ADD "played" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "competition_teams" ADD "won" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "competition_teams" ADD "drawn" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "competition_teams" ADD "lost" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "competition_teams" ADD "goals_for" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "competition_teams" ADD "goals_against" integer NOT NULL DEFAULT '0'`);
        ...
        await queryRunner.query(`ALTER TABLE "competition_teams" ADD "form" character varying(10)`);
        await queryRunner.query(`ALTER TABLE "competition_teams" ADD "created_at" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "competition_teams" ADD "updated_at" TIMESTAMP NOT NULL DEFAULT now()`);
        ...
        await queryRunner.query(`ALTER TABLE "competition_teams" DROP CONSTRAINT "PK_7deea733e2bee683c45130783a0"`);
        await queryRunner.query(`ALTER TABLE "competition_teams" ADD CONSTRAINT "PK_eb3390d51aa9d9bf91a9a535357" PRIMARY KEY ("competition_id", "team_id")`);
        ...
        await queryRunner.query(`ALTER TABLE "titles" ALTER COLUMN "year" SET NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "competition_teams" DROP CONSTRAINT "PK_de9cd3edac536bc447fc5be24fc"`);
        await queryRunner.query(`ALTER TABLE "competition_teams" ADD CONSTRAINT "PK_882b4e57cf463f0e23337bbd72e" PRIMARY KEY ("team_id", "id")`);
        await queryRunner.query(`ALTER TABLE "competition_teams" DROP CONSTRAINT "PK_882b4e57cf463f0e23337bbd72e"`);
        await queryRunner.query(`ALTER TABLE "competition_teams" ADD CONSTRAINT "PK_7deea733e2bee683c45130783a0" PRIMARY KEY ("id")`);
        await queryRunner.query(`ALTER TABLE "teams" ADD CONSTRAINT "UQ_5bb52f9ca6581157f87047dcaee" UNIQUE ("stadium_id")`);
        ...
        await queryRunner.query(`ALTER TABLE "competition_teams" ALTER COLUMN "competition_id" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "competition_teams" DROP CONSTRAINT "PK_7deea733e2bee683c45130783a0"`);
        await queryRunner.query(`ALTER TABLE "competition_teams" ADD CONSTRAINT "PK_ec0f374ac1e4f978389025ebf2f" PRIMARY KEY ("id", "competition_id")`);
        await queryRunner.query(`ALTER TABLE "competition_teams" ALTER COLUMN "team_id" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "competition_teams" DROP CONSTRAINT "PK_ec0f374ac1e4f978389025ebf2f"`);
        await queryRunner.query(`ALTER TABLE "competition_teams" ADD CONSTRAINT "PK_de9cd3edac536bc447fc5be24fc" PRIMARY KEY ("competition_id", "id", "team_id")`);
        ...
        await queryRunner.query(`ALTER TABLE "titles" ADD CONSTRAINT "FK_3e98fc29df8faba85b1b5c00c1a" FOREIGN KEY ("team_id") REFERENCES "teams"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "titles" ADD CONSTRAINT "FK_b619d159b4b41edc8c78171b446" FOREIGN KEY ("competition_id") REFERENCES "competitions"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "teams" ADD CONSTRAINT "FK_5bb52f9ca6581157f87047dcaee" FOREIGN KEY ("stadium_id") REFERENCES "stadiums"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "titles" DROP CONSTRAINT "FK_b619d159b4b41edc8c78171b446"`);
        await queryRunner.query(`ALTER TABLE "titles" DROP CONSTRAINT "FK_3e98fc29df8faba85b1b5c00c1a"`);
        ...
        await queryRunner.query(`ALTER TABLE "competition_teams" DROP CONSTRAINT "PK_de9cd3edac536bc447fc5be24fc"`);
        await queryRunner.query(`ALTER TABLE "competition_teams" ADD CONSTRAINT "PK_ec0f374ac1e4f978389025ebf2f" PRIMARY KEY ("competition_id", "id")`);
        await queryRunner.query(`ALTER TABLE "competition_teams" ALTER COLUMN "team_id" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "competition_teams" DROP CONSTRAINT "PK_ec0f374ac1e4f978389025ebf2f"`);
        await queryRunner.query(`ALTER TABLE "competition_teams" ADD CONSTRAINT "PK_7deea733e2bee683c45130783a0" PRIMARY KEY ("id")`);
        await queryRunner.query(`ALTER TABLE "competition_teams" ALTER COLUMN "competition_id" DROP NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "teams" DROP CONSTRAINT "UQ_5bb52f9ca6581157f87047dcaee"`);
        await queryRunner.query(`ALTER TABLE "competition_teams" DROP CONSTRAINT "PK_7deea733e2bee683c45130783a0"`);
        await queryRunner.query(`ALTER TABLE "competition_teams" ADD CONSTRAINT "PK_882b4e57cf463f0e23337bbd72e" PRIMARY KEY ("team_id", "id")`);
        await queryRunner.query(`ALTER TABLE "competition_teams" DROP CONSTRAINT "PK_882b4e57cf463f0e23337bbd72e"`);
        await queryRunner.query(`ALTER TABLE "competition_teams" ADD CONSTRAINT "PK_de9cd3edac536bc447fc5be24fc" PRIMARY KEY ("competition_id", "team_id", "id")`);
        ...
        await queryRunner.query(`ALTER TABLE "titles" ALTER COLUMN "year" DROP NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "competition_teams" DROP CONSTRAINT "PK_eb3390d51aa9d9bf91a9a535357"`);
        await queryRunner.query(`ALTER TABLE "competition_teams" ADD CONSTRAINT "PK_7deea733e2bee683c45130783a0" PRIMARY KEY ("id")`);
        ...
        await queryRunner.query(`ALTER TABLE "competition_teams" DROP CONSTRAINT "PK_7deea733e2bee683c45130783a0"`);
        await queryRunner.query(`ALTER TABLE "competition_teams" DROP COLUMN "id"`);
        await queryRunner.query(`ALTER TABLE "titles" DROP COLUMN "competition_id"`);
        await queryRunner.query(`ALTER TABLE "competition_teams" ADD "form" character varying(10)`);
        await queryRunner.query(`ALTER TABLE "competition_teams" ADD "group_name" character varying(50)`);
        await queryRunner.query(`ALTER TABLE "competition_teams" ADD "updated_at" TIMESTAMP DEFAULT CURRENT_TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "competition_teams" ADD "created_at" TIMESTAMP DEFAULT CURRENT_TIMESTAMP`);
        ...
        await queryRunner.query(`ALTER TABLE "competition_teams" ADD "goals_against" integer DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "competition_teams" ADD "goals_for" integer DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "competition_teams" ADD "lost" integer DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "competition_teams" ADD "drawn" integer DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "competition_teams" ADD "won" integer DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "competition_teams" ADD "played" integer DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "competition_teams" ADD "points" integer DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "competition_teams" ADD "position" integer`);
        await queryRunner.query(`ALTER TABLE "competition_teams" ADD "id" SERIAL NOT NULL`);
        await queryRunner.query(`ALTER TABLE "competition_teams" ADD CONSTRAINT "competition_teams_pkey" PRIMARY KEY ("id")`);
        ...
        await queryRunner.query(`ALTER TABLE "titles" ADD "image_url" text`);
        await queryRunner.query(`ALTER TABLE "titles" ADD "type" character varying(50)`);
        await queryRunner.query(`ALTER TABLE "titles" ADD "category" character varying(50)`);
        await queryRunner.query(`ALTER TABLE "titles" ADD "description" text`);
        await queryRunner.query(`ALTER TABLE "titles" ADD "season" character varying(100)`);
        await queryRunner.query(`ALTER TABLE "titles" ADD "competition_name" character varying(255)`);
        await queryRunner.query(`ALTER TABLE "titles" ADD "name" character varying(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "titles" ADD "updated_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "titles" ADD "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "titles" ADD "is_active" boolean NOT NULL DEFAULT true`);
        await queryRunner.query(`ALTER TABLE "titles" ADD "display_order" integer`);
        ...
        await queryRunner.query(`ALTER TABLE "titles" ADD CONSTRAINT "FK_3e98fc29df8faba85b1b5c00c1a" FOREIGN KEY ("team_id") REFERENCES "teams"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
