      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="space-y-4">
          ...
          {services.map((service, index) => (
            <div
              key={index}
              className={`border rounded-lg p-6 ${getStatusColor(service.status)} dark:bg-slate-800 dark:border-slate-600`}
            >
              <div className="flex items-center justify-between">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400 space-y-1">
                <code className="block bg-gray-100 dark:bg-slate-700 p-2 rounded">npm run deploy:status</code>
                <code className="block bg-gray-100 dark:bg-slate-700 p-2 rounded">npm run deploy:health</code>
              </div>
            </div>
          </div>
        </div>
