                ...
                <div className="bg-white shadow rounded-lg p-6">
                  ...
                  {h2hTeam1 && h2hTeam2 && headToHead ? (
                      ...
                      {headToHead.total_matches > 0 ? (
                        <>
                          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            <div className="bg-blue-50 p-4 rounded-lg shadow-sm">
                              ...
                              <p>Vitórias {headToHead.team1?.short_name || headToHead.team1?.name}: {headToHead.team1_wins}</p>
                              <p>Vitórias {headToHead.team2?.short_name || headToHead.team2?.name}: {headToHead.team2_wins}</p>
                              <p>Empates: {headToHead.draws}</p>
                              <p>Gols {headToHead.team1?.short_name || headToHead.team1?.name}: {headToHead.team1_goals}</p>
                              <p>Gols {headToHead.team2?.short_name || headToHead.team2?.name}: {headToHead.team2_goals}</p>
                            </div>
                          </div>
                        ...
                        <div className="text-center py-12">
                          ...
                          <h3 className="text-lg font-medium text-gray-900 mb-2">
                            {headToHead.team1?.name} vs {headToHead.team2?.name}
                          </h3>
                          <p className="text-gray-600">
                            Não há estatísticas para esse confronto na nossa base de dados.
                          </p>
                          <p className="text-sm text-gray-500 mt-2">
                            Estes times ainda não se enfrentaram nesta competição.
                          </p>
                        </div>
                      )}
                    </div>
                    ...
                    <div className="text-center py-8">
                      ...
                      <p className="text-gray-600 mt-2">Carregando confronto direto...</p>
                    </div>
                  ) : (
