...
export default function CompetitionsManager() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // 1. Criar ou atualizar os dados da competição
    try {
      ...
      // 2. Se houver um arquivo de logo, fazer o upload
      if (logoFile) {
        const logoFormData = new FormData()
        logoFormData.append('logo', logoFile)

        const uploadResponse = await fetch(
          `${API_ENDPOINTS.competitions.list()}/${savedCompetition.id}/upload-logo`, 
          {
            method: 'POST',
            body: logoFormData,
          }
      ...
      // 3. Atualizar a lista e fechar o modal
      fetchData()
      handleCloseModal()
                        ...
                        <div className="flex items-center">
                          <div className="h-10 w-10 flex-shrink-0">
                            <img
                              ...
                              src={competition.logo_url ? imageUrl(competition.logo_url) : `https://ui-avatars.com/api/?name=${competition.name}&background=random`}
                              alt=""
                            />
                          </div>
                          <div className="ml-4">
              ...
              <form onSubmit={handleSubmit} className="space-y-4 mt-4">
                ...
                <div className="pt-5">
                  <div className="flex justify-end">
                    ...
                    >
                      {editingCompetition ? 'Atualizar Competição' : 'Criar Competição'}
                    </button>
                  </div>
                </div>
              </form>
